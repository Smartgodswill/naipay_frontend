...
import 'package:naipay/screens/dashboard.dart';
              ...
              children: [
                ...
                Padding(
                  ...
                  child: PinCodeTextField(
                    ...
                    onCompleted: (value) {
                     state is OnboardingSentOtploadingState?
                      context.read<OnboardingBloc>().add(
                        OnVerifySentOtpEvent(email: widget.email, otp: value),
                      ): showDialog(context: context, builder: (context){
                        return  Center(
                          child: customContainer(50, 100, BoxDecoration(), CircularProgressIndicator(
